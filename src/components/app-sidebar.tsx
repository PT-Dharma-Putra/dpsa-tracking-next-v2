    ...
    navMain: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: 'Project V2 | Scan Barang Jadi',
            url: '/dashboard/projects-v2/scan-barang-jadi',
          },
          {
            title: 'Project V2 | Setrim Barang Jadi',
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: 'Semua Item Produksi',
            url: '/dashboard/projects-v2/produksi/items',
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: 'Project V2 | Rekap Penagihan',
            url: '/dashboard/projects-v2/rekap-penagihan',
          },
          {
